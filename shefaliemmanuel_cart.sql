...
INSERT INTO `carts` VALUES (3081,880,'2008-10-13 00:00:00');
...
CREATE TABLE `customers` (
  ...
  `shipaddr` varchar(255) DEFAULT 'See billing address',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `items` VALUES (5023,'dingus','gizmos',29.37),(5061,'bric-a-brac','widgets',2.00),(5913,'thingum','gizmos',5.00);
